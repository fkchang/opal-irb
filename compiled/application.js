...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def['$=='] = function(other) {
        var $a, $b, self = this;
        if ((($a = other['$is_a?']((($b = $scope.Sexp) == null ? $opal.cm('Sexp') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      $opal.cdecl($scope, 'STR_DQUOTE', (($a = $scope.STR_FUNC_EXPAND) == null ? $opal.cm('STR_FUNC_EXPAND') : $a));

      $opal.cdecl($scope, 'STR_XQUOTE', (($a = $scope.STR_FUNC_EXPAND) == null ? $opal.cm('STR_FUNC_EXPAND') : $a)['$|']((($a = $scope.STR_FUNC_XQUOTE) == null ? $opal.cm('STR_FUNC_XQUOTE') : $a)));

      $opal.cdecl($scope, 'STR_REGEXP', (($a = $scope.STR_FUNC_REGEXP) == null ? $opal.cm('STR_FUNC_REGEXP') : $a)['$|']((($a = $scope.STR_FUNC_ESCAPE) == null ? $opal.cm('STR_FUNC_ESCAPE') : $a))['$|']((($a = $scope.STR_FUNC_EXPAND) == null ? $opal.cm('STR_FUNC_EXPAND') : $a)));

      $opal.cdecl($scope, 'STR_SWORD', (($a = $scope.STR_FUNC_QWORDS) == null ? $opal.cm('STR_FUNC_QWORDS') : $a));

      $opal.cdecl($scope, 'STR_DWORD', (($a = $scope.STR_FUNC_QWORDS) == null ? $opal.cm('STR_FUNC_QWORDS') : $a)['$|']((($a = $scope.STR_FUNC_EXPAND) == null ? $opal.cm('STR_FUNC_EXPAND') : $a)));

      $opal.cdecl($scope, 'STR_SSYM', (($a = $scope.STR_FUNC_SYMBOL) == null ? $opal.cm('STR_FUNC_SYMBOL') : $a));

      $opal.cdecl($scope, 'STR_DSYM', (($a = $scope.STR_FUNC_SYMBOL) == null ? $opal.cm('STR_FUNC_SYMBOL') : $a)['$|']((($a = $scope.STR_FUNC_EXPAND) == null ? $opal.cm('STR_FUNC_EXPAND') : $a)));
      ...
      def.$read_escape = function() {
        ...
        if ((($a = self.$scan(/\\/)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          if ((($a = ($opal.Object._scope.Encoding == null ? nil : 'constant')) !== nil && (!$a._isBoolean || $a == true))) {
            return self.$scanner()['$[]'](1).$to_i(16).$chr((($a = ((($b = $scope.Encoding) == null ? $opal.cm('Encoding') : $b))._scope).UTF_8 == null ? $a.cm('UTF_8') : $a.UTF_8))
            } else {
            return ""
          }
          } else {
      ...
      def.$here_document = function(str_parse) {
        ...
        eos_regx = (new RegExp("[ \\t]*" + (($a = $scope.Regexp) == null ? $opal.cm('Regexp') : $a).$escape(str_parse['$[]']("term")) + "(\\r*\\n|$)"));
        expand = true;
        if ((($a = self.$check(eos_regx)) !== nil && (!$a._isBoolean || $a == true))) {
          self.$scan((new RegExp("[ \\t]*" + (($a = $scope.Regexp) == null ? $opal.cm('Regexp') : $a).$escape(str_parse['$[]']("term")))));
        ...
        if ((($b = self.$scan(/\n/)) !== nil && (!$b._isBoolean || $b == true))) {
          ...
          reg = (($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$new("[^#\u0000\\\\\n]+|.");
          self.$scan(reg);
          str_buffer['$<<'](self.$scanner().$matched());
        };};
      ...
      def.$parse_string = function() {
        var $a, $b, $c, self = this, str_parse = nil, func = nil, space = nil, qwords = nil, expand = nil, regexp = nil, str_buffer = nil, complete_str = nil;
        str_parse = self.$strterm();
        func = str_parse['$[]']("func");
        space = false;
        qwords = (func['$&']((($a = $scope.STR_FUNC_QWORDS) == null ? $opal.cm('STR_FUNC_QWORDS') : $a)))['$=='](0)['$!']();
        expand = (func['$&']((($a = $scope.STR_FUNC_EXPAND) == null ? $opal.cm('STR_FUNC_EXPAND') : $a)))['$=='](0)['$!']();
        regexp = (func['$&']((($a = $scope.STR_FUNC_REGEXP) == null ? $opal.cm('STR_FUNC_REGEXP') : $a)))['$=='](0)['$!']();
        if ((($a = (($b = qwords !== false && qwords !== nil) ? self.$scan(/\s+/) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          space = true};
        str_buffer = [];
        if ((($a = self.$scan((($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$new((($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$escape(str_parse['$[]']("term"))))) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        if (space !== false && space !== nil) {
          self['$yylval='](" ");
          return "tSPACE";};
        if ((($a = ($b = str_parse['$[]']("balance"), $b !== false && $b !== nil ?self.$scan((($c = $scope.Regexp) == null ? $opal.cm('Regexp') : $c).$new((($c = $scope.Regexp) == null ? $opal.cm('Regexp') : $c).$escape(str_parse['$[]']("paren")))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          str_buffer['$<<'](self.$scanner().$matched());
          ($a = "nesting", $b = str_parse, $b['$[]=']($a, $b['$[]']($a)['$+'](1)));
      ...
      def.$add_string_content = function(str_buffer, str_parse) {
        var $a, $b, $c, $d, self = this, func = nil, end_str_re = nil, qwords = nil, expand = nil, regexp = nil, escape = nil, xquote = nil, c = nil, handled = nil, reg = nil;
        func = str_parse['$[]']("func");
        end_str_re = (($a = $scope.Regexp) == null ? $opal.cm('Regexp') : $a).$new((($a = $scope.Regexp) == null ? $opal.cm('Regexp') : $a).$escape(str_parse['$[]']("term")));
        qwords = (func['$&']((($a = $scope.STR_FUNC_QWORDS) == null ? $opal.cm('STR_FUNC_QWORDS') : $a)))['$=='](0)['$!']();
        expand = (func['$&']((($a = $scope.STR_FUNC_EXPAND) == null ? $opal.cm('STR_FUNC_EXPAND') : $a)))['$=='](0)['$!']();
        regexp = (func['$&']((($a = $scope.STR_FUNC_REGEXP) == null ? $opal.cm('STR_FUNC_REGEXP') : $a)))['$=='](0)['$!']();
        escape = (func['$&']((($a = $scope.STR_FUNC_ESCAPE) == null ? $opal.cm('STR_FUNC_ESCAPE') : $a)))['$=='](0)['$!']();
        xquote = (func['$==']((($a = $scope.STR_XQUOTE) == null ? $opal.cm('STR_XQUOTE') : $a)));
        ...
        } else if ((($b = ($c = str_parse['$[]']("balance"), $c !== false && $c !== nil ?self.$scan((($d = $scope.Regexp) == null ? $opal.cm('Regexp') : $d).$new((($d = $scope.Regexp) == null ? $opal.cm('Regexp') : $d).$escape(str_parse['$[]']("paren")))) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
          ($b = "nesting", $c = str_parse, $c['$[]=']($b, $c['$[]']($b)['$+'](1)));
          c = self.$scanner().$matched();
        ...
        if (handled !== false && handled !== nil) {
          ...
          reg = (function() {if (qwords !== false && qwords !== nil) {
            return (($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$new("[^" + ((($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$escape(str_parse['$[]']("term"))) + "#\u0000\n \\\\]+|.")
          } else if ((($b = str_parse['$[]']("balance")) !== nil && (!$b._isBoolean || $b == true))) {
            return (($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$new("[^" + ((($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$escape(str_parse['$[]']("term"))) + ((($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$escape(str_parse['$[]']("paren"))) + "#\u0000\\\\]+|.")
            } else {
            return (($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$new("[^" + ((($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b).$escape(str_parse['$[]']("term"))) + "#\u0000\\\\]+|.")
          }; return nil; })();
          self.$scan(reg);
      ...
      def.$heredoc_identifier = function() {
        ...
        if ((($a = self.$scan(/(-?)['"]?(\w+)['"]?/)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          self['$strterm='](self.$new_strterm((($a = $scope.STR_DQUOTE) == null ? $opal.cm('STR_DQUOTE') : $a), heredoc, heredoc));
      ...
      def.$process_identifier = function(matched, cmd_start) {
        ...
        if ((($a = ($b = self.lex_state['$==']("expr_dot")['$!'](), $b !== false && $b !== nil ?kw = (($c = $scope.Keywords) == null ? $opal.cm('Keywords') : $c).$keyword(matched) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      return (def.$yylex = function() {
        ...
        if ((($b = self.$skip(/\ |\t|\r/)) !== nil && (!$b._isBoolean || $b == true))) {
          ...
          self['$strterm='](self.$new_strterm((($b = $scope.STR_DQUOTE) == null ? $opal.cm('STR_DQUOTE') : $b), "\"", "\x00"));
          return "tSTRING_BEG";
        } else if ((($b = self.$scan(/\'/)) !== nil && (!$b._isBoolean || $b == true))) {
          self['$strterm='](self.$new_strterm((($b = $scope.STR_SQUOTE) == null ? $opal.cm('STR_SQUOTE') : $b), "'", "\x00"));
          return "tSTRING_BEG";
        } else if ((($b = self.$scan(/\`/)) !== nil && (!$b._isBoolean || $b == true))) {
          self['$strterm='](self.$new_strterm((($b = $scope.STR_XQUOTE) == null ? $opal.cm('STR_XQUOTE') : $b), "`", "\x00"));
          return "tXSTRING_BEG";
        } else if ((($b = self.$scan(/\&/)) !== nil && (!$b._isBoolean || $b == true))) {
          if ((($b = self.$scan(/\&/)) !== nil && (!$b._isBoolean || $b == true))) {
            self.lex_state = "expr_beg";
          ...
          $b = $opal.to_ary((function() {$case = str_type;if ("Q"['$===']($case)) {return ["tSTRING_BEG", (($c = $scope.STR_DQUOTE) == null ? $opal.cm('STR_DQUOTE') : $c)]}else if ("q"['$===']($case)) {return ["tSTRING_BEG", (($c = $scope.STR_SQUOTE) == null ? $opal.cm('STR_SQUOTE') : $c)]}else if ("W"['$===']($case)) {self.$skip(/\s*/);
          return ["tWORDS_BEG", (($c = $scope.STR_DWORD) == null ? $opal.cm('STR_DWORD') : $c)];}else if ("w"['$===']($case) || "i"['$===']($case)) {self.$skip(/\s*/);
          return ["tAWORDS_BEG", (($c = $scope.STR_SWORD) == null ? $opal.cm('STR_SWORD') : $c)];}else if ("x"['$===']($case)) {return ["tXSTRING_BEG", (($c = $scope.STR_XQUOTE) == null ? $opal.cm('STR_XQUOTE') : $c)]}else if ("r"['$===']($case)) {return ["tREGEXP_BEG", (($c = $scope.STR_REGEXP) == null ? $opal.cm('STR_REGEXP') : $c)]}else { return nil }})()), token = ($b[0] == null ? nil : $b[0]), func = ($b[1] == null ? nil : $b[1]);
          self['$strterm='](self.$new_strterm2(func, term, paren));
          return token;
        } else if ((($b = self.$scan(/\//)) !== nil && (!$b._isBoolean || $b == true))) {
          if ((($b = self['$beg?']()) !== nil && (!$b._isBoolean || $b == true))) {
            self['$strterm='](self.$new_strterm((($b = $scope.STR_REGEXP) == null ? $opal.cm('STR_REGEXP') : $b), "/", "/"));
            return "tREGEXP_BEG";
          } else if ((($b = self.$scan(/\=/)) !== nil && (!$b._isBoolean || $b == true))) {
            self.lex_state = "expr_beg";
            return self.$new_op_asgn("/");
          ...
          if ((($b = self.$scan(/\=/)) !== nil && (!$b._isBoolean || $b == true))) {
            ...
            if ((($b = ((($c = self.lex_state['$==']("expr_beg")) !== false && $c !== nil) ? $c : ((($d = self.lex_state['$==']("expr_arg")) ? self.space_seen : $d)))) !== nil && (!$b._isBoolean || $b == true))) {
              ...
              self['$strterm='](self.$new_strterm2((($b = $scope.STR_DQUOTE) == null ? $opal.cm('STR_DQUOTE') : $b), end_word, start_word));
              return "tSTRING_BEG";}};
          self.$set_arg_state();
          return "tPERCENT";
        } else if ((($b = self.$scan(/\\/)) !== nil && (!$b._isBoolean || $b == true))) {
          ...
          if ((($b = ((($c = self['$end?']()) !== false && $c !== nil) ? $c : self.$check(/\s/))) !== nil && (!$b._isBoolean || $b == true))) {
            ...
            return "tSYMBEG";};
          if ((($b = self.$scan(/\'/)) !== nil && (!$b._isBoolean || $b == true))) {
            self['$strterm='](self.$new_strterm((($b = $scope.STR_SSYM) == null ? $opal.cm('STR_SSYM') : $b), "'", "\x00"))
          } else if ((($b = self.$scan(/\"/)) !== nil && (!$b._isBoolean || $b == true))) {
            self['$strterm='](self.$new_strterm((($b = $scope.STR_DSYM) == null ? $opal.cm('STR_DSYM') : $b), "\"", "\x00"))};
          self.lex_state = "expr_fname";
          return "tSYMBEG";
        } else if ((($b = self.$scan(/\^\=/)) !== nil && (!$b._isBoolean || $b == true))) {
          self.lex_state = "expr_beg";
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$s = function(parts) {
        var $a, self = this;
        parts = $slice.call(arguments, 0);
        return (($a = $scope.Sexp) == null ? $opal.cm('Sexp') : $a).$new(parts);
      };
      ...
      def.$new_block_args = function(norm, opt, rest, block) {
        ...
        if (norm !== false && norm !== nil) {
          ...
          if ((($a = arg['$is_a?']((($b = $scope.Symbol) == null ? $opal.cm('Symbol') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
              self.$scope().$add_local(arg);
    ...
    (function($base) {
      ...
      (function($base) {
        ...
        def.$lvar_to_js = function(var$) {
          var $a, $b, self = this;
          if ((($a = (($b = $scope.RESERVED) == null ? $opal.cm('RESERVED') : $b)['$include?'](var$.$to_s())) !== nil && (!$a._isBoolean || $a == true))) {
            var$ = "" + (var$) + "$"};
          return var$.$to_sym();
        };
        ...
        def.$js_truthy_optimize = function(sexp) {
          ...
          if (sexp.$type()['$==']("call")) {
            ...
            } else if ((($a = (($b = ((($c = $scope.Compiler) == null ? $opal.cm('Compiler') : $c))._scope).COMPARE == null ? $b.cm('COMPARE') : $b.COMPARE)['$include?'](mid.$to_s())) !== nil && (!$a._isBoolean || $a == true))) {
              return self.$expr(sexp)
            } else if (mid['$==']("==")) {
              return self.$expr(sexp)
              } else {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, $a, TMP_6;
...
if (str == null) str = nil;
          if ((($a = str['$is_a?']((($b = $scope.String) == null ? $opal.cm('String') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (def.$compile = function() {
          ...
          if (self.$value()['$==']("")) {
            ...
            return self.$push("" + ((($a = $scope.Regexp) == null ? $opal.cm('Regexp') : $a).$new(self.$value()).$inspect()) + (self.$flags()))
          };
        }, nil);
      })(self, (($a = $scope.Base) == null ? $opal.cm('Base') : $a));
      ...
      (function($base) {
        ...
        def.$compile_split_lines = function(value, sexp) {
          ...
          idx = 0;
          return ($a = ($b = value).$each_line, $a._p = (TMP_1 = function(line){var self = TMP_1._s || this, $a, line_sexp = nil, frag = nil;if (line == null) line = nil;
          if (idx['$=='](0)) {
              self.$push(line)
              } else {
              line_sexp = self.$s();
              line_sexp['$source=']([sexp.$line()['$+'](idx), 0]);
              frag = (($a = $scope.Fragment) == null ? $opal.cm('Fragment') : $a).$new(line, line_sexp);
              self.$push(frag);
            };
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, $a;
        def.sexp = nil;
        self.$include((($a = $scope.XStringLineSplitter) == null ? $opal.cm('XStringLineSplitter') : $a));
      ...
      (function($base, $super) {
        ...
        return (def.$compile = function() {
          var $a, $b, TMP_2, self = this;
          return ($a = ($b = self.$children()).$each_with_index, $a._p = (TMP_2 = function(part, idx){var self = TMP_2._s || this, $a, $b;if (part == null) part = nil;if (idx == null) idx = nil;
          if (idx['$=='](0)) {
              } else {
              self.$push(" + ")
            };
            if ((($a = (($b = $scope.String) == null ? $opal.cm('String') : $b)['$==='](part)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      (function($base, $super) {
        ...
        return (def.$compile = function() {
          var $a, $b, TMP_3, self = this;
          ($a = ($b = self.$children()).$each_with_index, $a._p = (TMP_3 = function(part, idx){var self = TMP_3._s || this, $a, $b;if (part == null) part = nil;if (idx == null) idx = nil;
          if (idx['$=='](0)) {
              } else {
              self.$push(" + ")
            };
      ...
      (function($base, $super) {
        ...
        return (def.$compile = function() {
          ...
          ($a = ($b = self.$children()).$each, $a._p = (TMP_4 = function(part){var self = TMP_4._s || this, $a, $b;
            if (self.sexp == null) self.sexp = nil;
if (part == null) part = nil;
      ...
      (function($base, $super) {
        ...
        return (def.$compile = function() {
          var $a, $b, TMP_5, self = this;
          ($a = ($b = self.$children()).$each_with_index, $a._p = (TMP_5 = function(part, idx){var self = TMP_5._s || this, $a, $b;if (part == null) part = nil;if (idx == null) idx = nil;
          if (idx['$=='](0)) {
              } else {
              self.$push(" + ")
            };
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, $a, TMP_1, $b, TMP_2, $c, TMP_3;
        ...
        def.$compile = function() {
          var $a, $b, self = this;
          if ((($a = (($b = $scope.HELPERS) == null ? $opal.cm('HELPERS') : $b)['$include?'](self.$meth().$to_sym())) !== nil && (!$a._isBoolean || $a == true))) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, $a, TMP_1, $b, TMP_4, $c, TMP_5, $d, TMP_6, $e, TMP_7, $f, TMP_8, $g, TMP_9;
        ...
        def.$compile = function() {
          ...
          if ((($a = ($c = (($d = $scope.Sexp) == null ? $opal.cm('Sexp') : $d)['$==='](self.$arglist().$last()), $c !== false && $c !== nil ?self.$arglist().$last().$type()['$==']("block_pass") : $c)) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$handle_special = function() {
          var $a, $b, self = this, result = nil;
          if ((($a = (($b = $scope.SPECIALS) == null ? $opal.cm('SPECIALS') : $b)['$include?'](self.$meth())) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          } else if ((($a = (($b = $scope.RuntimeHelpers) == null ? $opal.cm('RuntimeHelpers') : $b)['$compatible?'](self.$recvr(), self.$meth(), self.$arglist())) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          if ((($a = ($b = self.$args().$last()['$is_a?']((($c = $scope.Sexp) == null ? $opal.cm('Sexp') : $c)), $b !== false && $b !== nil ?self.$args().$last().$type()['$==']("splat") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$extract_opt_args = function() {
          ...
          if ((($a = ($b = self.$args().$last()['$is_a?']((($c = $scope.Sexp) == null ? $opal.cm('Sexp') : $c)), $b !== false && $b !== nil ?self.$args().$last().$type()['$==']("block") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$extract_block_arg = function() {
          ...
          if ((($a = ($b = self.$args().$last()['$is_a?']((($c = $scope.Sexp) == null ? $opal.cm('Sexp') : $c)), $b !== false && $b !== nil ?self.$args().$last().$type()['$==']("block_pass") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$args = function() {
          var $a, $b, $c, self = this;
          if ((($a = ((($b = (($c = $scope.Fixnum) == null ? $opal.cm('Fixnum') : $c)['$==='](self.$args_sexp())) !== false && $b !== nil) ? $b : self.$args_sexp()['$nil?']())) !== nil && (!$a._isBoolean || $a == true))) {
            return self.$s("array")
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          params = nil;
          scope_name = nil;
          if ((($a = (($b = $scope.Sexp) == null ? $opal.cm('Sexp') : $b)['$==='](self.$args().$last())) !== nil && (!$a._isBoolean || $a == true))) {
            opt = self.$args().$pop()};
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def['$skip_check_present?'] = function() {
          var $a, $b, self = this;
          return ((($a = self.$test()['$==']((($b = $scope.RUBY_ENGINE_CHECK) == null ? $opal.cm('RUBY_ENGINE_CHECK') : $b))) !== false && $a !== nil) ? $a : self.$test()['$==']((($b = $scope.RUBY_PLATFORM_CHECK) == null ? $opal.cm('RUBY_PLATFORM_CHECK') : $b)));
        };
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$rescue_variable = function() {
          ...
          if ((($a = ($b = (($c = $scope.Sexp) == null ? $opal.cm('Sexp') : $c)['$==='](variable), $b !== false && $b !== nil ?["lasgn", "iasgn"]['$include?'](variable.$type()) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            return variable.$dup()
            } else {
            return nil
          };
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          body_code = self.$stmt(self.$stmts());
            if ((($a = body_code['$is_a?']((($b = $scope.Array) == null ? $opal.cm('Array') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
              } else {
              body_code = [body_code]
            };
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$compile = function(source, options) {
        ...
        self.parser = (($a = $scope.Parser) == null ? $opal.cm('Parser') : $a).$new();
      ...
      def.$error = function(msg, line) {
        ...
        return self.$raise((($a = $scope.SyntaxError) == null ? $opal.cm('SyntaxError') : $a), "" + (msg) + " :" + (self.$file()) + ":" + (line));
      };
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$find_asset = function(path) {try {
        ...
        return ($a = ($b = file_types).$each, $a._p = (TMP_2 = function(type){var self = TMP_2._s || this, $a, $b, test = nil;if (type == null) type = nil;
          test = (($a = $scope.File) == null ? $opal.cm('File') : $a).$join(root, "" + (path) + (type));
            if ((($a = (($b = $scope.File) == null ? $opal.cm('File') : $b)['$exist?'](test)) !== nil && (!$a._isBoolean || $a == true))) {
              $opal.$return(test)
              } else {
              return nil
      ...
      def.$build_asset = function(path) {
        ...
        if ((($a = builder = (($b = $scope.BUILDERS) == null ? $opal.cm('BUILDERS') : $b)['$[]'](ext)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$find_contents = function() {
          ...
          inner = nil.$gsub(/\\'/, "'").$gsub(/\\"/, "\"");
            if ((($a = inner['$=~']((($b = $scope.BLOCK_EXPR) == null ? $opal.cm('BLOCK_EXPR') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
...
(function($opal) {
  ...
  $opal.add_stubs(['$Native', '$each', '$[]', '$is_a?', '$<<', '$sort_by', '$to_proc', '$uniq', '$attr_reader', '$new', '$compile']);
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    def.$opal_classes = function() {
      ...
      attr = $gvars["opal_js_object"]['$[]'](k);
        if ((($a = attr['$is_a?']((($b = $scope.Class) == null ? $opal.cm('Class') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
          return classes['$<<'](attr)
          } else {
          return nil
        };}, TMP_1._s = self, TMP_1), $a).call($b);
      return ($a = ($c = classes.$uniq()).$sort_by, $a._p = "name".$to_proc(), $a).call($c);
    };
    ...
    def.$initialize = function() {
      var $a, $b, self = this;
      return self.parser = (($a = ((($b = $scope.Opal) == null ? $opal.cm('Opal') : $b))._scope).Compiler == null ? $a.cm('Compiler') : $a.Compiler).$new();
    };

    return (def.$parse = function(cmd) {
      var self = this;
      return self.parser.$compile(cmd, $hash2(["irb"], {"irb": true}));
    }, nil);
  })(self, null);
})(Opal);
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    def.$initialize = function(output, input, prompt, inputdiv, inputl, inputr, inputcopy, settings) {
      ...
      self.settings = (($a = $scope.DEFAULT_SETTINGS) == null ? $opal.cm('DEFAULT_SETTINGS') : $a).$clone();
      self.irb = (($a = $scope.OpalIrb) == null ? $opal.cm('OpalIrb') : $a).$new();
      myself = self;
      ($a = ($b = self.input).$on, $a._p = (TMP_1 = function(evt){var self = TMP_1._s || this;if (evt == null) evt = nil;
      return myself.$handle_keypress(evt)}, TMP_1._s = self, TMP_1), $a).call($b, "keydown");
      self.$initialize_window();
      return self.$print_header();
    };

    def.$print = function(args) {
      var self = this, s = nil, o = nil;
      s = args;
    ...
    def.$process_saved = function() {
      ...
      compiled = self.irb.$parse(self.saved);
        ...
        if ((($a = e.$backtrace()) !== nil && (!$a._isBoolean || $a == true))) {
          output = ((("FOR:\n") + (compiled)) + "\n============\n")['$+'](e.$backtrace().$join("\n"))
          } else {
          output = e.toString()
        }
    ...
    def.$history = function() {
      var $a, $b, TMP_2, self = this;
      return ($a = ($b = self.history.$reverse()).$each_with_index, $a._p = (TMP_2 = function(line, i){var self = TMP_2._s || this;if (line == null) line = nil;if (i == null) i = nil;
      return self.$print("" + (i) + ": " + (line))}, TMP_2._s = self, TMP_2), $a).call($b);
    };
    ...
    def.$handle_keypress = function(e) {
      ...
      if (input !== false && input !== nil) {
        ...
        if ((($a = ($b = input['$[]']($range(0, -1, true))['$==']("\\")['$!'](), $b !== false && $b !== nil ?self.multiline['$!']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      return self.$show_next_history();}else if ((80)['$===']($case)) {if ((($a = e.$ctrl_key()) !== nil && (!$a._isBoolean || $a == true))) {
        e.$prevent_default();
        return self.$show_previous_history();
        } else {
        return nil
      }}else if ((78)['$===']($case)) {if ((($a = e.$ctrl_key()) !== nil && (!$a._isBoolean || $a == true))) {
        e.$prevent_default();
    ...
    def.$show_previous_history = function() {
      ...
      if (self.historyi['$<'](self.history.$length()['$-'](1))) {
        ...
        return self.input['$value='](self.history['$[]'](self.historyi));
        } else {
        return nil
      };
    };
    ...
    def.$setup_cmd_line_methods = function() {
      ...
      return ($a = ($b = (($c = $scope.CMD_LINE_METHOD_DEFINITIONS) == null ? $opal.cm('CMD_LINE_METHOD_DEFINITIONS') : $c)).$each, $a._p = (TMP_3 = function(method_defn){var self = TMP_3._s || this, compiled = nil;
        if (self.irb == null) self.irb = nil;
if (method_defn == null) method_defn = nil;
      compiled = self.irb.$parse(method_defn);
        return eval(compiled);}, TMP_3._s = self, TMP_3), $a).call($b);
    };

    def.$print_header = function() {
      var $a, $b, self = this;
      return self.$print(["# Opal v" + ((($a = ((($b = $scope.Opal) == null ? $opal.cm('Opal') : $b))._scope).VERSION == null ? $a.cm('VERSION') : $a.VERSION)) + " IRB", "# <a href=\"https://github.com/fkchang/opal-irb\" target=\"_blank\">https://github.com/fkchang/opal-irb</a>", "# inspired by <a href=\"https://github.com/larryng/coffeescript-repl\" target=\"_blank\">https://github.com/larryng/coffeescript-repl</a>", "#", "# <strong>help</strong> for features and tips.", " "].$join("\n"));
    };

    $opal.defs(self, '$create_html', function(parent_container_id) {
      var $a, self = this, parent = nil;
    ...
    $opal.defs(self, '$create', function(container_id) {
      var $a, $b, TMP_4, $c, TMP_5, $d, TMP_6, $e, TMP_7, $f, TMP_8, $g, self = this, output = nil, input = nil, prompt = nil, inputdiv = nil, inputl = nil, inputr = nil, inputcopy = nil, irb = nil;
      ...
      ($a = ($b = input).$on, $a._p = (TMP_4 = function(){var self = TMP_4._s || this;
      return irb.$scroll_to_bottom()}, TMP_4._s = self, TMP_4), $a).call($b, "keydown");
      ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find(window)).$on, $a._p = (TMP_5 = function(e){var self = TMP_5._s || this;if (e == null) e = nil;
      return irb.$resize_input(e)}, TMP_5._s = self, TMP_5), $a).call($c, "resize");
      ($a = ($d = input).$on, $a._p = (TMP_6 = function(e){var self = TMP_6._s || this;if (e == null) e = nil;
      return irb.$resize_input(e)}, TMP_6._s = self, TMP_6), $a).call($d, "keyup");
      ($a = ($e = input).$on, $a._p = (TMP_7 = function(e){var self = TMP_7._s || this;if (e == null) e = nil;
      return irb.$resize_input(e)}, TMP_7._s = self, TMP_7), $a).call($e, "change");
      ($a = ($f = (($g = $scope.Element) == null ? $opal.cm('Element') : $g).$find("html")).$on, $a._p = (TMP_8 = function(e){var self = TMP_8._s || this;if (e == null) e = nil;
      return input.$focus()}, TMP_8._s = self, TMP_8), $a).call($f, "click");
...
(function($opal) {
  ...
  $opal.add_stubs(['$ready?', '$create']);
  ;
  ;
  ;
  ;
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a;
  return (($a = $scope.OpalIRBHomebrewConsole) == null ? $opal.cm('OpalIRBHomebrewConsole') : $a).$create("#container")}, TMP_1._s = self, TMP_1), $a).call($b);
})(Opal);
